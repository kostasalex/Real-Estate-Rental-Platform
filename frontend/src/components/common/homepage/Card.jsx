...
function Card(props) {
	...
	const convertedRating = (props.review_scores_rating / maxRating) * targetMaxRating;
								...
								<ul className="m-0 flex list-none items-center justify-between px-0 pt-6 pb-0">
									...
									<li className="text-left">
										...
										<ul className="m-0 flex items-center p-0 font-medium">
											...
											<li className="ml-2 inline text-base"><p>{roundedRating}({props.number_of_reviews} Reviews)</p></li>
										</ul>
									</li>
								</ul>
							</div>
