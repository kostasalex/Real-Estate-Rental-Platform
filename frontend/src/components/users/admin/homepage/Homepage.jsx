...
const Homepage = () => {
  return (
    <div className='flex md:justify-center justify-end mr-10  '>
        <div className="mt-10 ml-10 lg:flex-row flex-col flex ">
            <div className="bg-blue-500 lg:px-10 px-5 ml-2 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
                ...
                <div className="text-center ml-10 ">
                    <p className="md:text-2xl text-md">1,257</p>
                    <p>Users</p>
                </div>
            </div>
            <div className="bg-blue-500 lg:px-10 px-5  ml-2 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
                ...
                <div className="text-center ml-10">
                    <p className="md:text-2xl text-md">557</p>
                    <p>Bookings</p>
                </div>
            </div>
            <div className="bg-blue-500 lg:px-10 px-5 ml-2 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
                ...
                <div className="text-center ml-10">
                    <p className="md:text-2xl text-md">$11,257</p>
                    <p>Sales</p>
                </div>
            </div>
        </div>
